...
import { coerceDiceAccent, getDiceAccentColorSync, loadDiceAccentColor, saveDiceAccentColor, } from '@/utils/dice-color-storage';
...
export function useDiceAccentColor() {
    ...
    const setAccent = useCallback(async (hex) => {
