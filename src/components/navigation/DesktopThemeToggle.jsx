...
export function useIsDesktopSidebarVisible() {
    const { width } = useWindowDimensions();
...
export function ThemeToggle() {
    ...
    return (<Pressable accessibilityRole="button" accessibilityLabel={isDark ? 'Включить светлую тему' : 'Включить тёмную тему'} onPress={handlePress} style={({ pressed }) => [styles.button, pressed && styles.pressed]}>
