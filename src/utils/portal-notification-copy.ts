...
export const TOAST_PORTAL_NOTIFICATION_TYPES: ReadonlySet<PortalNotification['type']> = new Set([
  'favorite_received',
  'favorite_returned',
  'game_application',
...
export function getPortalNotificationToastVariant(
...
export function getChatMessageToastCopy(message: ChatMessage): PortalNotificationCopy {
...
export function getChatMessageToastVariant(message: ChatMessage): ToastVariant {
  const kind = message.kind ?? 'user';
