...
import { fetchCurrentUser, guestLogin, loginUser, logoutUser, refreshAuthTokens, registerUser, } from '@/services/auth/authApi';
import { onAccessTokenRefreshed } from '@/services/auth/token-refresh';
import { clearAuthSession, getStoredRefreshToken, getStoredToken, getStoredUser, patchStoredUser, saveAuthSession, } from '@/utils/auth-storage';
...
import { bootstrapYandexMetrika, reachYandexMetrikaGoal, setYandexMetrikaUserId, } from '@/services/analytics/yandex-metrika';
